#	Manejo de herencia
#	Función super()
#	De acuerdo donde se coloque, llamará al método de la clase padre
class Vehiculos():
...
#	Herencia Multiple, dará prioridad de acuerdo al primer constructor que se defina
class BicletaElectrica(VElectricos,Vehiculos):
	pass

miBici=BicletaElectrica("ecobici","cdmx20")